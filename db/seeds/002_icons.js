// =============================================
//  Seed: Custom Medical Icons
//  Populates icon library with custom medical icons
// =============================================
...
exports.seed = async function(knex) {
  ...
  // Insert custom medical icons
  await knex('icons').insert([
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "search", name: "Search", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "sleep-apnoea", name: "Sleep apnoea", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "quality-of-life", name: "Quality of life", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "mortality", name: "Mortality", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "lungs", name: "Lungs", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    <g>
      ...
      <path class="cls-1" d="M6.52,15.69c.48-.5,1.10-.87,1.77-1.05"/>
      <path class="cls-1" d="M8.33,13.46c-.45-.04-.91-.09-1.36-.13"/>
    </g>
  </svg>` },
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "derma", name: "Derma", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "eye-complications", name: "Eye complications", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "heart", name: "Heart", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "liver", name: "Liver", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "diabetes", name: "Diabetes", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "renal", name: "Renal", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1, .cls-2 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "clinical-outcomes", name: "Clinical outcomes", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "urgency-to-treat", name: "Urgency to treat", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "adverse-events", name: "Adverse events", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "clinical-trials-guidelines", name: "Clinical trials guidelines", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "lifestyle", name: "Lifestyle", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "psychological-burden", name: "Psychological burden", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "bariatric-surgery", name: "Bariatric surgery", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          stroke-miterlimit: 10;
    ...
    <path class="cls-2" d="M3.42,9.81h.02s6.16,1.64,6.16,1.64c.14.04.25.13.32.25.04.07.1.14.18.15,1.76.39,3.54.77,5.31,1.17.27.06.72.2,1.18.53.34.24.57.51.72.71-.14.15-.39.4-.75.59-1.07.59-2.24.31-3.12.09-.84-.20-1.26-.31-1.57-.68-.21-.26-.33-.58-.77-.91-.25-.19-.47-.29-.56-.32-.3-.11-.65-.35-.78-.15-.11.16-.3.25-.5.21l-6.3-.95c-.21-.02-.38-.2-.39-.42-.02-.29,0-.58.06-.87s.16-.56.29-.82c.1-.17.31-.27.51-.23Z"/>
    <line class="cls-2" x1="9.25" y1="13.09" x2="9.59" y2="11.45"/>
  </svg>` },
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "social-stigma", name: "Social stigma", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "patient-eligibility", name: "Patient eligibility", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "multidisciplinary-team", name: "Multidisciplinary team", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "scales", name: "Scales", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: #fff;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "pills", name: "Pills", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "syringe", name: "Syringe", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "target", name: "Target", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "dna", name: "DNA", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "stethoscope", name: "Stethoscope", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "low-energy", name: "Low energy", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "mc4r-pathway-diseases", name: "MC4R pathway diseases", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: #fff;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "hunger-hyperphagia", name: "Hunger hyperphagia", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: #1d1d1b;
    ...
    { tenant_id: DEFAULT_TENANT_ID, icon_id: "obesity", name: "Obesity", category: "Custom", is_public: true, svg: `<svg id="Guides" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <defs>
      <style>
        .cls-1 {
          fill: none;
